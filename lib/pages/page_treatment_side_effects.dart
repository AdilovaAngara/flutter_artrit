...
import 'package:artrit/pages/page_treatment_side_effects_edit.dart';
import 'package:flutter/material.dart';
import '../my_functions.dart';
import '../roles.dart';
import '../secure_storage.dart';
import '../theme.dart';
import '../widget_another/treatment_side_effects_view_widget.dart';
...
class PageTreatmentSideEffects extends StatefulWidget {
  final String title;

  const PageTreatmentSideEffects({
    super.key,
    required this.title,
  });

  @override
  State<PageTreatmentSideEffects> createState() => PageTreatmentSideEffectsState();
}

class PageTreatmentSideEffectsState extends State<PageTreatmentSideEffects> {
  ...
  /// Данные
  List<DataTreatmentSideEffects>? _thisData;
  ...
  void _navigateAndRefresh(BuildContext context, bool isEditForm,
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => PageTreatmentSideEffectsEdit(
          title: widget.title,
  ...
  bool _delBtnShow(List<DataTreatmentSideEffects> thisData, int index) {
                      ...
                      itemBuilder: (context, index) {
                        return Padding(
                          ...
                          child: ListTileExpandWidget(
                            title: _thisData![index].ny != null
                                ? _thisData![index].ny!
                                : 'Название не указано',
                            subtitle: getSubtitleTreatmentSideEffects(_thisData![index]),
                            ...
                            child: Column(
                              ...
                              children: [
                                TreatmentSideEffectsViewWidget(
