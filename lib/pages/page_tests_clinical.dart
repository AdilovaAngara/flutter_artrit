import 'package:artrit/pages/page_tests_clinical_edit.dart';
...
import '../theme.dart';
import '../widget_another/tests_clinical_view_widget.dart';
...
class PageTestsClinical extends StatefulWidget {
  ...
  @override
  State<PageTestsClinical> createState() => _PageTestsClinicalState();
}

class _PageTestsClinicalState extends State<PageTestsClinical> {
  ...
  /// Данные
  List<DataTestsClinicalList>? _thisData;
  DataTestsClinical? _thisDataRecord;
  ...
  bool _delBtnShow(List<DataTestsClinicalList> thisData, int index) {
