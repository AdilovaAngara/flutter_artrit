import 'package:artrit/pages/page_scale_main_patient_edit.dart';
import 'package:flutter/material.dart';
import '../api/api_scale_main_patient.dart';
import '../data/data_scale_main_patient.dart';
...
class PageScaleMainPatient extends StatefulWidget {
  ...
  @override
  State<PageScaleMainPatient> createState() => _PageScaleMainPatientState();
}

class _PageScaleMainPatientState extends State<PageScaleMainPatient> {
  ...
  /// Данные
  List<DataScaleMainPatient>? _thisData;
  ...
  bool _delBtnShow(List<DataScaleMainPatient> thisData, int index) {
