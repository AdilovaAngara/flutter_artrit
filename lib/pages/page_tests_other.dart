import 'package:artrit/pages/page_tests_other_edit.dart';
import 'package:flutter/material.dart';
import '../api/api_tests_other.dart';
import '../data/data_tests_other.dart';
import '../my_functions.dart';
import '../roles.dart';
import '../secure_storage.dart';
import '../theme.dart';
import '../widget_another/tests_other_view_widget.dart';
...
class PageTestsOther extends StatefulWidget {
  ...
  @override
  State<PageTestsOther> createState() => _PageTestsOtherState();
}

class _PageTestsOtherState extends State<PageTestsOther> {
 ...
 void _navigateAndRefresh(BuildContext context, bool isEditForm,
  ...
  bool _delBtnShow(List<DataTestsOther> thisData, int index) {
