...
import 'package:artrit/pages/page_anamnesis_concomitants_edit.dart';
import 'package:flutter/material.dart';
import '../my_functions.dart';
import '../roles.dart';
import '../secure_storage.dart';
import '../theme.dart';
import '../widget_another/anamnesis_concomitants_view_widget.dart';
...
class PageAnamnesisConcomitants extends StatefulWidget {
  ...
  @override
  State<PageAnamnesisConcomitants> createState() => PageAnamnesisConcomitantsState();
}

class PageAnamnesisConcomitantsState extends State<PageAnamnesisConcomitants> {
  ...
  /// Данные
  List<DataAnamnesisConcomitants>? _thisData;
  ...
  bool _delBtnShow(List<DataAnamnesisConcomitants> thisData, int index) {
                      ...
                      itemBuilder: (context, index) {
                        return Padding(
                          ...
                          child: ListTileExpandWidget(
                            title: _thisData![index].diagnosis != null
                                ? _thisData![index].diagnosis ?? ''
                                : 'Название не указано',
                            subtitle: getSubtitleAnamnesisConcomitants(_thisData![index]),
                            ...
                            child: Column(
                              ...
                              children: [
                                AnamnesisConcomitantsViewWidget(
