...
import 'package:artrit/pages/page_researches_edit.dart';
...
class PageResearchesList extends StatefulWidget {
  ...
  @override
  State<PageResearchesList> createState() => _PageResearchesListState();
}

class _PageResearchesListState extends State<PageResearchesList> {
  ...
  Future<void> _loadData() async {
    ...
    final allData = await _api.get(patientsId: _patientsId);
    _thisData =
        allData.where((research) => research.typeId == widget.typeId).toList();
    setState(() {
  ...
  bool _delBtnShow(List<DataResearches> thisData, int index) {
                                      ...
                                      ResearchesViewWidget(
                                        fileName: _thisData![index].filename !=
                                                ...
                                                _thisData![index]
                                                    .filename!
                                                    .isNotEmpty
                                            ? _thisData![index].filename![0]
                                            : '',
                                        fileId:
                                            _thisData![index].fileIds != null &&
                                                    _thisData![index]
                                                        .fileIds!
                                                        .isNotEmpty
                                                ? _thisData![index].fileIds![0]
                                                : '',
                                        comment:
