import 'package:artrit/pages/page_treatment_medicaments_edit.dart';
...
import '../theme.dart';
import '../widget_another/treatment_medicaments_view_widget.dart';
...
class PageTreatmentMedicaments extends StatefulWidget {
  final String title;

  const PageTreatmentMedicaments({
    super.key,
    required this.title,
  });

  @override
  State<PageTreatmentMedicaments> createState() => PageTreatmentMedicamentsState();
}

class PageTreatmentMedicamentsState extends State<PageTreatmentMedicaments> {
  ...
  /// Данные
  List<DataTreatmentMedicaments>? _thisData;
  ...
  void _navigateAndRefresh(BuildContext context, bool isEditForm,
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => PageTreatmentMedicamentsEdit(
            title: widget.title,
  ...
  bool _delBtnShow(List<DataTreatmentMedicaments> thisData, int index) {
  ...
  bool _editBtnShow(List<DataTreatmentMedicaments> thisData, int index) {
    if (thisData[index].dop == null) return true;
    if (thisData[index].dop!.checkbox == null || !thisData[index].dop!.checkbox!) return false;
    return true;
  }
                      ...
                      itemBuilder: (context, index) {
                        return Padding(
                          ...
                          child: ListTileExpandWidget(
                            title: _thisData![index].tnp != null
                                ? _thisData![index].tnp!
                                : 'Название не указано',
                            subtitle: getSubtitleTreatmentMedicaments(_thisData![index]),
                            ...
                            child: Column(
                              ...
                              children: [
                                TreatmentMedicamentsViewWidget(
                                  thisData: _thisData![index],
                                ),
                                Row(
                                  children: [
                                    if (_editBtnShow(_thisData!, index))
                                    ButtonWidget(
                                      labelText: 'Изменить',
