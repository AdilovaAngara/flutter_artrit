...
import 'package:artrit/pages/page_vaccination_edit.dart';
...
class PageVaccination extends StatefulWidget {
  final String title;

  const PageVaccination({
    super.key,
    required this.title,
  });

  @override
  State<PageVaccination> createState() => PageVaccinationState();
}

class PageVaccinationState extends State<PageVaccination> {
  ...
  /// Данные
  List<DataVaccination>? _thisData;
  ...
  bool _delBtnShow(List<DataVaccination> thisData, int index) {
                      ...
                      itemBuilder: (context, index) {
                        return Padding(
                          ...
                          child: ListTileExpandWidget(
                            title: _thisData![index].name ?? 'Не указано',
                            subtitle: _thisData![index].executeDate != null ?
                            dateFormat(_thisData![index].executeDate!) : 'Не указана',
                            ...
                            child: Column(
                              ...
                              children: [
                                ResearchesViewWidget(
                                  ...
                                  fileId:
                                  _thisData![index].fileId != null &&
                                      _thisData![index]
                                          .fileId!
                                          .isNotEmpty
                                      ? _thisData![index].fileId!
                                      : '',
                                  comment:
